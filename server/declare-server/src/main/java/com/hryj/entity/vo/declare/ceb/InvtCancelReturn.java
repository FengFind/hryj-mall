...
public class InvtCancelReturn {
	...
	public InvtCancelReturn() {
	}

	public InvtCancelReturn(String guid, String copNo, String preNo,
			String invtNo, String returnStatus, String returnTime,
			String returnInfo, String customsCode, String ebpCode,
			String ebcCode, String agentCode) {
		super();
		this.guid = guid;
		this.copNo = copNo;
		this.preNo = preNo;
