...
public class InvtCancel {
	...
	public InvtCancel(String guid, String appType, String appTime,
			String appStatus, String customsCode, String orderNo,
			String ebpCode, String ebpName, String ebcCode, String ebcName,
			String logisticsNo, String logisticsCode, String logisticsName,
			String copNo, String preNo, String invtNo, String buyerIdType,
			String buyerIdNumber, String buyerName, String buyerTelephone,
			String agentCode, String agentName, String reason, String note) {
		super();
		this.guid = guid;
		this.appType = appType;
		this.appTime = appTime;
