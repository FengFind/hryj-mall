 ...
 * @description: 门店端购物车服务
 * @create 2018/6/29 18:38
 **/
@Slf4j
@RestController
@RequestMapping(value = "/storeCart")
public class ShoppingCartForStoreController {
    ...
    public Result addShoppingCart(@RequestBody ShoppingCartRequestVO shoppingCartRequestVO) {
        ...
        return shoppingCartService.addShoppingCart(shoppingCartRequestVO,CodeCache.getValueByKey("ShoppingCartType","S02"));
    }
    ...
    public Result updateShoppingCart(@RequestBody ShoppingCartRequestVO shoppingCartRequestVO){
        return shoppingCartService.updateShoppingCart(shoppingCartRequestVO,CodeCache.getValueByKey("ShoppingCartType","S02"));
    }
    ...
    public Result<ShoppingCartResponseVO> findShoppingCartList(@RequestBody ShoppingCartForStoreRequestVO shoppingCartForStoreRequestVO) {
        ...
        return shoppingCartService.findShoppingCartList(shoppingCartForStoreRequestVO.getLogin_token(), shoppingCartForStoreRequestVO.getUser_id());
    }
