...
/**
 * @author 王光银
 * @className: PageProductTypePermissionRequestVO
 * @description:
 * @create 2018/9/13 0013 16:44
 **/
public abstract class PageProductTypePermissionRequestVO extends PageRequestVO implements ProductTypePermissionProcess {

    public abstract String getProduct_type_id();

    public abstract void setProduct_type_id(String product_type_id);
